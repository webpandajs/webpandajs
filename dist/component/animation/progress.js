 ...
 */
webpanda.data({name:"component://animation/progress",selector:"body",template:{src:webpanda.env.src("component/animation/progress.html")},onpageprogress:function(t){var e;this.percent=t.percent,100==this.percent?(this.firstShow=!1,e=this,webpanda.timer(function(){e.show=!1}).timeout(150).start()):this.show=!0},construct:function(){this.loaded=0,this.total=0,this.percent=0,this.show=!1,this.background="#2d8cf0",this.percentColor="#2d8cf0",this.firstShow=!0}});